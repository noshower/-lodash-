...
; (function () {
    ...
    var reIsDeepProp = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,
        reIsPlainProp = /^\w*$/, //匹配任意数量的字母、数字、下划线
    ...
    function arrayAggregator(array, setter, iteratee, accumulator) {
        //从-1开始，可以避免在while底部多写一行代码(index++)
        var index = -1,
     ...
     * iteratee shorthands.
     * 
     * 数组的foreach方法，跟原生的不同，arrayEach返回数组。
     * 
     * @private
     * @param {Array} [array] The array to iterate over.
    ...
    /**
     * `_.property`方法的基础实现，不支持深度路径
     * @private
     * @param {string} key 要获取的属性的key
     * @returns {Function} 返回新的访问函数
     */
    ...
    var runInContext = (function runInContext(context) {
         ...
         * @private
         * @param {Object} object 要查询的对象
         * @param {Array|string} path 要得到的属性的访问路径path
        ...
        /**
         * `baseProperty`的特别版本，支持深度路径
         *
         * @private
         * @param {Array|string} path 要得到的属性的路径path
         ...
         * @private
         * @param {*} value 要检查的值
         * @param {Object} [object] 要查询keys的对象
         * @returns {Array} 返回属性路径的数组
         */
        function castPath(value, object) {
            if (isArray(value)) {
                return value;
            }
            //如果value是单个属性，就返回[value]
        ...
        /**
         * {name:'noshower',age:22,love:'read'}
         * 返回二维数组，每个数组成员，包括对象的一个属性，一个值，一个是否可以严格比较的标志
         * [ [ 'name', 'noshower', true ], [ 'age', 22, true ],[ 'love', 'read', true ] ]
         * @private
         * @param {Object} object The object to query.
        ...
        /**
         * 检查value是属性名而不是属性的路径,isKey的意思是，是否是对象的键
         * @private
         * @param {*} value The value to check.
        ...
        function isKey(value, object) {
            //如果value是数组，直接返回。可能是包含多个属性的数组
            if (isArray(value)) {
                return false;
            }
            var type = typeof value; // 类型为number,symbol,boolean,值为null都能作为对象的键
            if (type == 'number' || type == 'symbol' || type == 'boolean' ||
                value == null || isSymbol(value)) {
                return true;
            }
            //如果value是简单的属性（字母、数字、下划线构成的属性名），就返回true，如果value不是路径就返回true
            // object不是null,且value是object的属性。
        ...
        function isStrictComparable(value) {
            ...
            // 所有对象不适合严格比较，返回false（这里的对象指的是isObject方法返回true的值）
        ...
        function matchesStrictComparable(key, srcValue) {
            return function (object) {
                ...
                //如果要匹配srcValue为undefined的情况，不仅object[key]等于undefined，而且，object上确实有key属性
        ...
        var countBy = createAggregator(function (result, value, key) {
            if (hasOwnProperty.call(result, key)) {//如果结果对象中存在key，key对应的值加1
                ++result[key];
            } else {
                baseAssignValue(result, key, 1);//给result分配属性key，值为1
            }
        });
        ...
        /**
         * 
         * 检查value是否是对象，是对象，则返回true。 不是则返回false。特别的，当value是null，isObject 返回false
         * 
         * @static
         * @memberOf _
         * @since 0.1.0
        ...
        /**
         *  创建一个函数，返回所给对象在`path`下的属性值。
         * @static
         * @memberOf _
         * @since 2.4.0
         * @category Util
         * @param {Array|string} path 要得到的属性的path值
         * @returns {Function} 返回一个新的访问函数
         * @example
         *
         * var objects = [
         *   { 'a': { 'b': 2 } },
